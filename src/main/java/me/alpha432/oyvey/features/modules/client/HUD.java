...
public class HUD extends Module {
    ...
    public Setting<String> gameTitle = register(new Setting("AppTitle", "Incoming v1.2.6"));
    ...
    private final Setting<String> waterMarkName = register(new Setting("WaterMarkName", "Incoming v1.2.6", v -> this.waterMark.getValue(true)));
